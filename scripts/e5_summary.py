...
Writes results/n78/e5_ablation.{txt,md}. Pure read/aggregate -- no model
or data is touched.
"""
...
CELLS = {
    "chind":        "runs/pretrain/chind_no_bcic_n78/probe_bcic_2b_loso.json",
    "G1 + full":    "runs/pretrain/g1full_no_bcic_n78/probe_bcic_2b_loso.json",
    "G1 + pos_only":"runs/pretrain/g1posonly_no_bcic_n78/probe_bcic_2b_loso.json",
    "G2 + full":    "runs/pretrain/g2full_no_bcic_n78/probe_bcic_2b_loso.json",
    "G2 + pos_only":"runs/pretrain/g2posonly_no_bcic_n78/probe_bcic_2b_loso.json",
    "G3 + full":    "runs/pretrain/geometric_no_bcic_n78/probe_bcic_2b_loso.json",
    "G3 + pos_only":"runs/pretrain/geomposonly_no_bcic_n78/probe_bcic_2b_loso.json",
}
