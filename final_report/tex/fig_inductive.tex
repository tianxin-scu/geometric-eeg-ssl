...
\begin{figure}[h]
  ...
  \begin{tikzpicture}[x=1cm, y=1cm]
    ...
    \node[purplebox, minimum width=4.4cm] (gR) at (8.5, -3)
      {\small $g_{ij} \in \mathbb{R}^{10}$\\[-2pt]
       \scriptsize $[\,p_i,\, p_j,\, p_i - p_j,\, \|p_i - p_j\|\,]$};
    ...
    \node[bluebox, minimum width=5.4cm, minimum height=1.0cm] (attR) at (8.5, -5.7)
      {\small Geometric attention (G3)\\[-2pt]
       \scriptsize geometry biases both score and value via shared MLP$(g_{ij})$};
